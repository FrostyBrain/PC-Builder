...
public class RAMAttach : MonoBehaviour
{
    [SerializeField]
    private GameObject RAMMarker;
    [SerializeField]
    private OVRGrabbable GrabbableRef;
    private string currentPartName="RAM";

    public void OnTriggerEnter(Collider other)
    {
        if (other.tag == currentPartName&&currentPartName=="RAM")
        {
        ...
        else if (other.tag == currentPartName&&currentPartName=="cpu_cooler")
        {
