...
public class RAMAttach2 : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        else if (other.tag == currentPartName&&currentPartName=="ram1")
        {
