...
public class RAMAttach3 : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        else if (other.tag == currentPartName&&currentPartName=="ram2")
        {
